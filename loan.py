...
with col2:
  Married=st.selectbox('Select your Criteria',sorted(Married))
with col3:
  Dependents=st.selectbox('Select your Criteria',sorted(Dependents))
with col4:
  Education=st.selectbox('Select your Criteria',sorted(Education))
with col5:
  Self_Employed=st.selectbox('Select your Criteria',sorted(Self_Employed))
...
if st.button('Predict Loan Approval'):
    ...
    user_input_df = pd.DataFrame("/content/project.csv")
